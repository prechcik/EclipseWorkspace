...
public class ZenAntiBan {
    public int ANTIBAN_RATE = 25; // This is the frequency rate for anti-ban actions (in % terms - 100% = frequent, 0% = never
    public int MIN_WAIT_NO_ACTION = 600; // This is the minimum time to wait if no action was taken
    public int MAX_WAIT_NO_ACTION = 1400; // This is the maximum time to wait if no action was taken
    ...
    private boolean DO_RANDOM = true; // This is a generic flag for randomly doing something early in a script for anti-patterning
